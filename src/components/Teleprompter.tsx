                  ...
                  <div className="shrink-0 flex flex-col items-center">
                    ...
                    {originalKey && displayKey !== originalKey && (
                      <span className="inline-flex items-center gap-1 mt-0.5">
                        ...
                        <span className="text-[8px] uppercase font-bold text-primary/80 bg-primary/10 px-1 py-px rounded">modif.</span>
                      </span>
                    )}
                  </div>
                )}
      ...
      >
        ...
        <div className="flex items-center">
          <Popover>
            ...
            <PopoverContent className="w-[300px] p-0 z-[200] bg-transparent border-0 shadow-none" side="top" align="center">
              <TranspositionControl
