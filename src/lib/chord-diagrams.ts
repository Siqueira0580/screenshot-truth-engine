...
const CHORD_DB: Record<string, Record<string, ChordVoicing>> = {
  ...
  cavaquinho: {
    ...
    // ── Major 6th ─────────────────────────────────────────────────
    C6:       { frets: [0, 3, 0, 4] },
    "C#6":    { frets: [4, 4, 4, 3], barres: [{ fret: 4, from: 0, to: 2 }], baseFret: 4 },
    Db6:      { frets: [4, 4, 4, 3], barres: [{ fret: 4, from: 0, to: 2 }], baseFret: 4 },
    D6:       { frets: [0, 2, 0, 4] },
    "D#6":    { frets: [1, 3, 1, 5], baseFret: 1 },
    Eb6:      { frets: [1, 3, 1, 5], baseFret: 1 },
    E6:       { frets: [2, 1, 2, 2] },
    F6:       { frets: [0, 2, 1, 2] },
    "F#6":    { frets: [4, 4, 4, 3], barres: [{ fret: 4, from: 0, to: 2 }], baseFret: 2 },
    Gb6:      { frets: [4, 4, 4, 3], barres: [{ fret: 4, from: 0, to: 2 }], baseFret: 2 },
    G6:       { frets: [0, 0, 2, 0] },
    "G#6":    { frets: [1, 1, 1, 0] },
    Ab6:      { frets: [1, 1, 1, 0] },
    A6:       { frets: [0, 2, 2, 1] },
    "A#6":    { frets: [3, 3, 3, 2], barres: [{ fret: 3, from: 0, to: 2 }], baseFret: 3 },
    Bb6:      { frets: [3, 3, 3, 2], barres: [{ fret: 3, from: 0, to: 2 }], baseFret: 3 },
    B6:       { frets: [2, 2, 2, 1], barres: [{ fret: 2, from: 0, to: 2 }] },

    // ── Minor 6th ─────────────────────────────────────────────────
    Cm6:      { frets: [2, 3, 1, 1], barres: [{ fret: 1, from: 2, to: 3 }] },
    "C#m6":   { frets: [3, 4, 2, 2], barres: [{ fret: 2, from: 2, to: 3 }] },
    Dbm6:     { frets: [3, 4, 2, 2], barres: [{ fret: 2, from: 2, to: 3 }] },
    Dm6:      { frets: [0, 2, 0, 4] },
    "D#m6":   { frets: [1, 3, 1, 5], baseFret: 1 },
    Ebm6:     { frets: [1, 3, 1, 5], baseFret: 1 },
    Em6:      { frets: [4, 4, 3, 4], baseFret: 2 },
    Fm6:      { frets: [0, 1, 1, 2] },
    "F#m6":   { frets: [4, 4, 3, 3], baseFret: 2 },
    Gbm6:     { frets: [4, 4, 3, 3], baseFret: 2 },
    Gm6:      { frets: [0, 0, 0, 1] },
    "G#m6":   { frets: [1, 1, 1, 2] },
    Abm6:     { frets: [1, 1, 1, 2] },
    Am6:      { frets: [0, 2, 1, 1], barres: [{ fret: 1, from: 2, to: 3 }] },
    "A#m6":   { frets: [3, 3, 2, 2], barres: [{ fret: 3, from: 0, to: 1 }], baseFret: 3 },
    Bbm6:     { frets: [3, 3, 2, 2], barres: [{ fret: 3, from: 0, to: 1 }], baseFret: 3 },
    Bm6:      { frets: [2, 2, 1, 1], barres: [{ fret: 2, from: 0, to: 1 }] },

    // ── Dominant 9th ──────────────────────────────────────────────
    C9:       { frets: [0, 3, 0, 2] },
    "C#9":    { frets: [4, 4, 4, 6], barres: [{ fret: 4, from: 0, to: 2 }], baseFret: 4 },
    Db9:      { frets: [4, 4, 4, 6], barres: [{ fret: 4, from: 0, to: 2 }], baseFret: 4 },
    D9:       { frets: [0, 4, 0, 2] },
    "D#9":    { frets: [1, 3, 2, 3], baseFret: 1 },
    Eb9:      { frets: [1, 3, 2, 3], baseFret: 1 },
    E9:       { frets: [2, 4, 3, 4], baseFret: 2 },
    F9:       { frets: [0, 2, 1, 3] },
    "F#9":    { frets: [4, 3, 2, 4], baseFret: 2 },
    Gb9:      { frets: [4, 3, 2, 4], baseFret: 2 },
    G9:       { frets: [0, 2, 0, 0] },
    "G#9":    { frets: [1, 1, 1, 4], barres: [{ fret: 1, from: 0, to: 2 }] },
    Ab9:      { frets: [1, 1, 1, 4], barres: [{ fret: 1, from: 0, to: 2 }] },
    A9:       { frets: [0, 2, 2, 4] },
    "A#9":    { frets: [3, 3, 3, 5], barres: [{ fret: 3, from: 0, to: 2 }], baseFret: 3 },
    Bb9:      { frets: [3, 3, 3, 5], barres: [{ fret: 3, from: 0, to: 2 }], baseFret: 3 },
    B9:       { frets: [2, 2, 2, 4], barres: [{ fret: 2, from: 0, to: 2 }] },

    // ── 7sus4 ─────────────────────────────────────────────────────
    C7sus4:   { frets: [0, 3, 1, 1], barres: [{ fret: 1, from: 2, to: 3 }] },
    "C#7sus4":{ frets: [1, 1, 2, 0] },
    Db7sus4:  { frets: [1, 1, 2, 0] },
    D7sus4:   { frets: [0, 2, 0, 1] },
    "D#7sus4":{ frets: [1, 3, 1, 2] },
    Eb7sus4:  { frets: [1, 3, 1, 2] },
    E7sus4:   { frets: [2, 4, 5, 3], baseFret: 2 },
    F7sus4:   { frets: [0, 3, 1, 0] },
    "F#7sus4":{ frets: [4, 4, 2, 0], baseFret: 2 },
    Gb7sus4:  { frets: [4, 4, 2, 0], baseFret: 2 },
    G7sus4:   { frets: [0, 0, 1, 3] },
    "G#7sus4":{ frets: [1, 1, 2, 4], barres: [{ fret: 1, from: 0, to: 1 }] },
    Ab7sus4:  { frets: [1, 1, 2, 4], barres: [{ fret: 1, from: 0, to: 1 }] },
    A7sus4:   { frets: [0, 2, 2, 3] },
    "A#7sus4":{ frets: [3, 3, 4, 3], barres: [{ fret: 3, from: 0, to: 3 }], baseFret: 3 },
    Bb7sus4:  { frets: [3, 3, 4, 3], barres: [{ fret: 3, from: 0, to: 3 }], baseFret: 3 },
    B7sus4:   { frets: [2, 2, 2, 3], barres: [{ fret: 2, from: 0, to: 2 }] },

    // ── Diminished 7th ────────────────────────────────────────────
    Cdim7:    { frets: [2, 3, 2, 0] },
    "C#dim7": { frets: [3, 4, 3, 1] },
    Dbdim7:   { frets: [3, 4, 3, 1] },
    Ddim7:    { frets: [0, 1, 0, 1] },
    "D#dim7": { frets: [1, 2, 1, 2] },
    Ebdim7:   { frets: [1, 2, 1, 2] },
    Edim7:    { frets: [2, 0, 2, 0] },
    Fdim7:    { frets: [3, 1, 0, 1] },
    "F#dim7": { frets: [0, 2, 1, 2] },
    Gbdim7:   { frets: [0, 2, 1, 2] },
    Gdim7:    { frets: [0, 1, 0, 0] },
    "G#dim7": { frets: [1, 2, 1, 1] },
    Abdim7:   { frets: [1, 2, 1, 1] },
    Adim7:    { frets: [2, 3, 2, 2] },
    "A#dim7": { frets: [3, 4, 3, 3], baseFret: 3 },
    Bbdim7:   { frets: [3, 4, 3, 3], baseFret: 3 },
    Bdim7:    { frets: [4, 5, 4, 4], baseFret: 4 },

    // ── Minor Major 7th (mMaj7 / m7M) ────────────────────────────
    CmMaj7:   { frets: [0, 0, 0, 1] },
    "C#mMaj7":{ frets: [1, 1, 1, 2], barres: [{ fret: 1, from: 0, to: 2 }] },
    DbmMaj7:  { frets: [1, 1, 1, 2], barres: [{ fret: 1, from: 0, to: 2 }] },
    DmMaj7:   { frets: [0, 2, 3, 1] },
    "D#mMaj7":{ frets: [1, 3, 4, 2], baseFret: 1 },
    EbmMaj7:  { frets: [1, 3, 4, 2], baseFret: 1 },
    EmMaj7:   { frets: [2, 0, 0, 1] },
    FmMaj7:   { frets: [3, 1, 1, 2] },
    "F#mMaj7":{ frets: [4, 2, 2, 3], baseFret: 2 },
    GbmMaj7:  { frets: [4, 2, 2, 3], baseFret: 2 },
    GmMaj7:   { frets: [0, 0, 0, 2] },
    "G#mMaj7":{ frets: [1, 1, 1, 3], barres: [{ fret: 1, from: 0, to: 2 }] },
    AbmMaj7:  { frets: [1, 1, 1, 3], barres: [{ fret: 1, from: 0, to: 2 }] },
    AmMaj7:   { frets: [2, 2, 1, 1] },
    "A#mMaj7":{ frets: [3, 3, 2, 2], baseFret: 2 },
    BbmMaj7:  { frets: [3, 3, 2, 2], baseFret: 2 },
    BmMaj7:   { frets: [4, 4, 3, 3], baseFret: 3 },

    // ── Minor 9th (m9) ───────────────────────────────────────────
    Cm9:      { frets: [3, 3, 3, 4], barres: [{ fret: 3, from: 0, to: 2 }], baseFret: 3 },
    "C#m9":   { frets: [4, 4, 4, 5], barres: [{ fret: 4, from: 0, to: 2 }], baseFret: 4 },
    Dbm9:     { frets: [4, 4, 4, 5], barres: [{ fret: 4, from: 0, to: 2 }], baseFret: 4 },
    Dm9:      { frets: [0, 2, 1, 0] },
    "D#m9":   { frets: [1, 3, 2, 1] },
    Ebm9:     { frets: [1, 3, 2, 1] },
    Em9:      { frets: [2, 0, 0, 2] },
    Fm9:      { frets: [3, 1, 1, 3] },
    "F#m9":   { frets: [4, 2, 2, 4], baseFret: 2 },
    Gbm9:     { frets: [4, 2, 2, 4], baseFret: 2 },
    Gm9:      { frets: [0, 0, 0, 3] },
    "G#m9":   { frets: [1, 1, 1, 4], barres: [{ fret: 1, from: 0, to: 2 }] },
    Abm9:     { frets: [1, 1, 1, 4], barres: [{ fret: 1, from: 0, to: 2 }] },
    Am9:      { frets: [0, 2, 1, 2] },
    "A#m9":   { frets: [3, 3, 2, 3], barres: [{ fret: 3, from: 0, to: 3 }], baseFret: 3 },
    Bbm9:     { frets: [3, 3, 2, 3], barres: [{ fret: 3, from: 0, to: 3 }], baseFret: 3 },
    Bm9:      { frets: [4, 4, 3, 4], barres: [{ fret: 4, from: 0, to: 3 }], baseFret: 4 },

    // ── Major 9th (Maj9 / M9 / 7M9) ──────────────────────────────
    CM9:      { frets: [0, 0, 0, 4] },
    Cmaj9:    { frets: [0, 0, 0, 4] },
    "C#M9":   { frets: [1, 1, 1, 5], barres: [{ fret: 1, from: 0, to: 2 }] },
    "C#maj9": { frets: [1, 1, 1, 5], barres: [{ fret: 1, from: 0, to: 2 }] },
    DbM9:     { frets: [1, 1, 1, 5], barres: [{ fret: 1, from: 0, to: 2 }] },
    Dbmaj9:   { frets: [1, 1, 1, 5], barres: [{ fret: 1, from: 0, to: 2 }] },
    DM9:      { frets: [0, 2, 3, 4] },
    Dmaj9:    { frets: [0, 2, 3, 4] },
    "D#M9":   { frets: [1, 3, 4, 5], baseFret: 1 },
    EbM9:     { frets: [1, 3, 4, 5], baseFret: 1 },
    EM9:      { frets: [2, 1, 0, 2] },
    Emaj9:    { frets: [2, 1, 0, 2] },
    FM9:      { frets: [3, 2, 1, 0] },
    Fmaj9:    { frets: [3, 2, 1, 0] },
    ...
    GM9:      { frets: [0, 0, 2, 0] },
    Gmaj9:    { frets: [0, 0, 2, 0] },
    "G#M9":   { frets: [1, 1, 3, 1], barres: [{ fret: 1, from: 0, to: 3 }] },
    AbM9:     { frets: [1, 1, 3, 1], barres: [{ fret: 1, from: 0, to: 3 }] },
    AM9:      { frets: [2, 2, 4, 2], barres: [{ fret: 2, from: 0, to: 3 }] },
    Amaj9:    { frets: [2, 2, 4, 2], barres: [{ fret: 2, from: 0, to: 3 }] },
    "A#M9":   { frets: [3, 3, 5, 3], barres: [{ fret: 3, from: 0, to: 3 }], baseFret: 3 },
    BbM9:     { frets: [3, 3, 5, 3], barres: [{ fret: 3, from: 0, to: 3 }], baseFret: 3 },
    BM9:      { frets: [4, 4, 6, 4], barres: [{ fret: 4, from: 0, to: 3 }], baseFret: 4 },
    Bmaj9:    { frets: [4, 4, 6, 4], barres: [{ fret: 4, from: 0, to: 3 }], baseFret: 4 },

    // ── Dominant 7b9 ──────────────────────────────────────────────
    C7b9:     { frets: [0, 0, 0, 0] },
    "C#7b9":  { frets: [1, 1, 1, 1], barres: [{ fret: 1, from: 0, to: 3 }] },
    Db7b9:    { frets: [1, 1, 1, 1], barres: [{ fret: 1, from: 0, to: 3 }] },
    D7b9:     { frets: [0, 2, 1, 2] },
    "D#7b9":  { frets: [1, 3, 2, 3], baseFret: 1 },
    Eb7b9:    { frets: [1, 3, 2, 3], baseFret: 1 },
    E7b9:     { frets: [2, 1, 0, 0] },
    F7b9:     { frets: [3, 2, 1, 3] },
    "F#7b9":  { frets: [4, 3, 2, 4], baseFret: 2 },
    Gb7b9:    { frets: [4, 3, 2, 4], baseFret: 2 },
    G7b9:     { frets: [0, 0, 0, 3] },
    "G#7b9":  { frets: [1, 1, 1, 4], barres: [{ fret: 1, from: 0, to: 2 }] },
    Ab7b9:    { frets: [1, 1, 1, 4], barres: [{ fret: 1, from: 0, to: 2 }] },
    A7b9:     { frets: [2, 2, 2, 3] },
    "A#7b9":  { frets: [3, 3, 3, 4], barres: [{ fret: 3, from: 0, to: 2 }], baseFret: 3 },
    Bb7b9:    { frets: [3, 3, 3, 4], barres: [{ fret: 3, from: 0, to: 2 }], baseFret: 3 },
    B7b9:     { frets: [4, 4, 4, 5], barres: [{ fret: 4, from: 0, to: 2 }], baseFret: 4 },
    ...
    Gb69:     { frets: [4, 3, 4, 1] },
    G69:      { frets: [0, 0, 2, 0] },
    "G#69":   { frets: [1, 1, 3, 1], barres: [{ fret: 1, from: 0, to: 3 }] },
    Ab69:     { frets: [1, 1, 3, 1], barres: [{ fret: 1, from: 0, to: 3 }] },
    A69:      { frets: [2, 2, 4, 2], barres: [{ fret: 2, from: 0, to: 3 }] },
    "A#69":   { frets: [3, 3, 5, 3], barres: [{ fret: 3, from: 0, to: 3 }], baseFret: 3 },
    Bb69:     { frets: [3, 3, 5, 3], barres: [{ fret: 3, from: 0, to: 3 }], baseFret: 3 },
    B69:      { frets: [4, 4, 6, 4], barres: [{ fret: 4, from: 0, to: 3 }], baseFret: 4 },
  },
...
const CHORD_ALT_VOICINGS: Record<string, Record<string, ChordVoicing[]>> = {
  ...
  cavaquinho: {
    ...
    C6:   [{ frets: [0, 3, 0, 4] }, { frets: [5, 5, 5, 2], barres: [{ fret: 5, from: 0, to: 2 }], baseFret: 5 }],
    D6:   [{ frets: [0, 2, 0, 4] }, { frets: [5, 5, 3, 4], baseFret: 3 }],
    E6:   [{ frets: [4, 4, 4, 4], barres: [{ fret: 4, from: 0, to: 3 }], baseFret: 2 }, { frets: [2, 1, 0, 1] }],
    F6:   [{ frets: [0, 2, 1, 2] }, { frets: [5, 5, 5, 3], barres: [{ fret: 5, from: 0, to: 2 }], baseFret: 5 }],
    G6:   [{ frets: [0, 5, 3, 4], baseFret: 3 }, { frets: [0, 0, 2, 0] }],
    A6:   [{ frets: [0, 2, 2, 1] }, { frets: [2, 4, 5, 1], baseFret: 2 }],
    B6:   [{ frets: [2, 2, 2, 1], barres: [{ fret: 2, from: 0, to: 2 }] }, { frets: [4, 4, 4, 3], barres: [{ fret: 4, from: 0, to: 2 }], baseFret: 4 }],
    "C#6": [{ frets: [1, 1, 1, 2], barres: [{ fret: 1, from: 0, to: 2 }] }],
    "Db6": [{ frets: [1, 1, 1, 2], barres: [{ fret: 1, from: 0, to: 2 }] }],
    "Eb6": [{ frets: [3, 3, 3, 1], barres: [{ fret: 3, from: 0, to: 2 }], baseFret: 3 }],
    "F#6": [{ frets: [2, 2, 2, 4], barres: [{ fret: 2, from: 0, to: 2 }] }],
    "Ab6": [{ frets: [1, 3, 1, 1], baseFret: 3 }],
    "Bb6": [{ frets: [1, 1, 1, 3] }],

    // ── m6 (Minor 6) alternatives ─────────────────────────────
    Cm6:  [{ frets: [2, 3, 1, 1], barres: [{ fret: 1, from: 2, to: 3 }] }, { frets: [5, 5, 4, 2], baseFret: 3 }],
    Dm6:  [{ frets: [0, 2, 0, 4] }, { frets: [5, 5, 3, 1], baseFret: 3 }],
    Em6:  [{ frets: [4, 4, 3, 4], baseFret: 2 }, { frets: [2, 1, 0, 4] }],
    Fm6:  [{ frets: [0, 1, 1, 2] }, { frets: [3, 1, 1, 2], baseFret: 5 }],
    Gm6:  [{ frets: [0, 5, 3, 1], baseFret: 3 }, { frets: [0, 0, 1, 0] }],
    Am6:  [{ frets: [0, 2, 1, 1], barres: [{ fret: 1, from: 2, to: 3 }] }, { frets: [2, 4, 4, 1], baseFret: 2 }],
    Bm6:  [{ frets: [2, 2, 1, 1], barres: [{ fret: 1, from: 2, to: 3 }] }, { frets: [4, 4, 3, 3], baseFret: 4 }],
    "C#m6": [{ frets: [1, 1, 0, 2] }],
    "Ebm6": [{ frets: [3, 3, 2, 1], baseFret: 3 }],
    "F#m6": [{ frets: [2, 2, 1, 4] }],
    "Abm6": [{ frets: [1, 1, 0, 1], baseFret: 3 }],
    "Bbm6": [{ frets: [1, 1, 0, 2] }],

    // ── mMaj7 (Minor Major 7) alternatives ────────────────────
    CmMaj7:  [{ frets: [0, 0, 0, 1] }, { frets: [5, 5, 4, 4], baseFret: 3 }],
    DmMaj7:  [{ frets: [0, 2, 3, 1] }, { frets: [5, 5, 3, 3], baseFret: 3 }],
    EmMaj7:  [{ frets: [2, 0, 0, 1] }, { frets: [4, 4, 3, 3], baseFret: 2 }],
    FmMaj7:  [{ frets: [3, 1, 1, 2] }, { frets: [0, 1, 1, 1], barres: [{ fret: 1, from: 1, to: 3 }] }],
    GmMaj7:  [{ frets: [0, 0, 0, 2] }, { frets: [5, 5, 3, 4], baseFret: 3 }],
    AmMaj7:  [{ frets: [2, 2, 1, 1] }, { frets: [0, 2, 1, 1], barres: [{ fret: 1, from: 2, to: 3 }] }],
    BmMaj7:  [{ frets: [4, 4, 3, 3], baseFret: 3 }, { frets: [2, 2, 1, 1] }],
    "C#mMaj7": [{ frets: [1, 1, 1, 2], barres: [{ fret: 1, from: 0, to: 2 }] }],
    "EbmMaj7": [{ frets: [3, 3, 2, 2], baseFret: 3 }],
    "F#mMaj7": [{ frets: [4, 2, 2, 3], baseFret: 2 }],
    "AbmMaj7": [{ frets: [1, 1, 1, 3], barres: [{ fret: 1, from: 0, to: 2 }] }],
    "BbmMaj7": [{ frets: [3, 3, 2, 2], baseFret: 2 }],

    // ── m9 (Minor 9) alternatives ─────────────────────────────
    Cm9:  [{ frets: [3, 3, 3, 4], barres: [{ fret: 3, from: 0, to: 2 }], baseFret: 3 }, { frets: [0, 3, 0, 1] }],
    Dm9:  [{ frets: [0, 2, 1, 0] }, { frets: [5, 5, 4, 0], baseFret: 3 }],
    Em9:  [{ frets: [2, 0, 0, 2] }, { frets: [4, 4, 3, 2], baseFret: 2 }],
    Fm9:  [{ frets: [3, 1, 1, 3] }, { frets: [0, 1, 1, 3] }],
    Gm9:  [{ frets: [0, 0, 0, 3] }, { frets: [5, 5, 3, 5], baseFret: 3 }],
    Am9:  [{ frets: [0, 2, 1, 2] }, { frets: [0, 0, 1, 2] }],
    Bm9:  [{ frets: [4, 4, 3, 4], barres: [{ fret: 4, from: 0, to: 3 }], baseFret: 4 }, { frets: [2, 2, 1, 2], barres: [{ fret: 2, from: 0, to: 3 }] }],
    "C#m9": [{ frets: [4, 4, 4, 5], barres: [{ fret: 4, from: 0, to: 2 }], baseFret: 4 }],
    "Ebm9": [{ frets: [1, 3, 2, 1] }],
    "F#m9": [{ frets: [4, 2, 2, 4], baseFret: 2 }],
    "Abm9": [{ frets: [1, 1, 1, 4], barres: [{ fret: 1, from: 0, to: 2 }] }],
    ...
    // ── Maj9 (Major 9) alternatives ───────────────────────────
    CM9:     [{ frets: [0, 0, 0, 4] }, { frets: [5, 5, 5, 4], baseFret: 3 }],
    Cmaj9:   [{ frets: [0, 0, 0, 4] }, { frets: [5, 5, 5, 4], baseFret: 3 }],
    DM9:     [{ frets: [0, 2, 3, 4] }, { frets: [0, 2, 0, 4] }],
    Dmaj9:   [{ frets: [0, 2, 3, 4] }, { frets: [0, 2, 0, 4] }],
    EM9:     [{ frets: [2, 1, 0, 2] }, { frets: [4, 4, 4, 2], baseFret: 2 }],
    Emaj9:   [{ frets: [2, 1, 0, 2] }, { frets: [4, 4, 4, 2], baseFret: 2 }],
    FM9:     [{ frets: [3, 2, 1, 0] }, { frets: [0, 2, 1, 3] }],
    Fmaj9:   [{ frets: [3, 2, 1, 0] }, { frets: [0, 2, 1, 3] }],
    GM9:     [{ frets: [0, 0, 2, 0] }, { frets: [0, 5, 4, 5], baseFret: 3 }],
    Gmaj9:   [{ frets: [0, 0, 2, 0] }, { frets: [0, 5, 4, 5], baseFret: 3 }],
    AM9:     [{ frets: [2, 2, 4, 2], barres: [{ fret: 2, from: 0, to: 3 }] }, { frets: [0, 2, 2, 2] }],
    Amaj9:   [{ frets: [2, 2, 4, 2], barres: [{ fret: 2, from: 0, to: 3 }] }, { frets: [0, 2, 2, 2] }],
    BM9:     [{ frets: [4, 4, 6, 4], barres: [{ fret: 4, from: 0, to: 3 }], baseFret: 4 }],
    Bmaj9:   [{ frets: [4, 4, 6, 4], barres: [{ fret: 4, from: 0, to: 3 }], baseFret: 4 }],
    "C#M9":  [{ frets: [1, 1, 1, 5], barres: [{ fret: 1, from: 0, to: 2 }] }],
    "C#maj9":[{ frets: [1, 1, 1, 5], barres: [{ fret: 1, from: 0, to: 2 }] }],
    ...
    // ── 7b9 (Dominant 7 flat 9) alternatives ──────────────────
    C7b9:    [{ frets: [0, 0, 0, 0] }, { frets: [3, 3, 3, 1], barres: [{ fret: 3, from: 0, to: 2 }], baseFret: 3 }],
    D7b9:    [{ frets: [0, 2, 1, 2] }, { frets: [5, 5, 4, 3], baseFret: 3 }],
    E7b9:    [{ frets: [2, 4, 3, 4], baseFret: 2 }, { frets: [0, 1, 0, 1] }],
    F7b9:    [{ frets: [0, 1, 1, 3] }, { frets: [3, 1, 0, 0] }],
    G7b9:    [{ frets: [0, 5, 3, 1], baseFret: 3 }, { frets: [0, 2, 3, 1] }],
    A7b9:    [{ frets: [0, 2, 2, 3] }, { frets: [2, 4, 5, 3], baseFret: 2 }],
    B7b9:    [{ frets: [2, 2, 2, 3], barres: [{ fret: 2, from: 0, to: 2 }] }, { frets: [4, 4, 4, 1], baseFret: 4 }],
    "C#7b9": [{ frets: [1, 1, 1, 1], barres: [{ fret: 1, from: 0, to: 3 }] }],
    "Eb7b9": [{ frets: [3, 3, 3, 4], barres: [{ fret: 3, from: 0, to: 2 }], baseFret: 3 }],
    "F#7b9": [{ frets: [2, 2, 2, 3], barres: [{ fret: 2, from: 0, to: 2 }] }],
    "Ab7b9": [{ frets: [1, 1, 1, 2], barres: [{ fret: 1, from: 0, to: 2 }] }],
    "Bb7b9": [{ frets: [1, 1, 0, 3] }],

    // ── 6/9 (Major 6/9) alternatives ──────────────────────────
    C69:     [{ frets: [0, 3, 0, 2] }, { frets: [5, 5, 5, 5], barres: [{ fret: 5, from: 0, to: 3 }], baseFret: 3 }],
    D69:     [{ frets: [0, 4, 0, 2] }, { frets: [0, 2, 0, 2] }],
    E69:     [{ frets: [2, 1, 0, 4] }, { frets: [4, 4, 4, 1], baseFret: 2 }],
    F69:     [{ frets: [0, 2, 1, 0] }, { frets: [3, 2, 1, 3] }],
    G69:     [{ frets: [0, 0, 2, 2] }, { frets: [0, 5, 3, 2], baseFret: 3 }],
    A69:     [{ frets: [0, 2, 2, 4] }, { frets: [2, 2, 4, 4], baseFret: 2 }],
    B69:     [{ frets: [2, 2, 2, 4], barres: [{ fret: 2, from: 0, to: 2 }] }],
    "C#69":  [{ frets: [1, 1, 1, 2], barres: [{ fret: 1, from: 0, to: 2 }] }],
    "Eb69":  [{ frets: [3, 3, 3, 3], barres: [{ fret: 3, from: 0, to: 3 }], baseFret: 3 }],
    "F#69":  [{ frets: [4, 2, 2, 4], baseFret: 2 }],
    "Ab69":  [{ frets: [1, 1, 3, 4] }],
    "Bb69":  [{ frets: [1, 1, 0, 0] }],

    // ── Sharp/Flat Major alternatives (Cavaquinho) ────────────
    "C#":  [{ frets: [1, 1, 1, 1], barres: [{ fret: 1, from: 0, to: 3 }] }, { frets: [6, 6, 6, 6], barres: [{ fret: 6, from: 0, to: 3 }], baseFret: 6 }],
    "Db":  [{ frets: [1, 1, 1, 1], barres: [{ fret: 1, from: 0, to: 3 }] }],
    "Eb":  [{ frets: [3, 3, 3, 3], barres: [{ fret: 3, from: 0, to: 3 }], baseFret: 3 }],
    "F#":  [{ frets: [4, 4, 3, 4], baseFret: 2 }, { frets: [2, 2, 2, 2], barres: [{ fret: 2, from: 0, to: 3 }] }],
    "Gb":  [{ frets: [2, 2, 2, 2], barres: [{ fret: 2, from: 0, to: 3 }] }],
    "Ab":  [{ frets: [3, 3, 3, 3], barres: [{ fret: 3, from: 0, to: 3 }] }, { frets: [1, 3, 1, 1], baseFret: 3 }],
    "G#":  [{ frets: [3, 3, 3, 3], barres: [{ fret: 3, from: 0, to: 3 }] }],

    // ── Sharp/Flat Minor alternatives (Cavaquinho) ────────────
    "C#m": [{ frets: [1, 1, 0, 1], barres: [{ fret: 1, from: 0, to: 3 }] }],
    "Ebm": [{ frets: [3, 3, 2, 3], barres: [{ fret: 3, from: 0, to: 3 }], baseFret: 3 }],
    "F#m": [{ frets: [2, 2, 1, 2], barres: [{ fret: 2, from: 0, to: 3 }] }],
    "G#m": [{ frets: [1, 1, 0, 1], baseFret: 3 }],
    "Abm": [{ frets: [1, 1, 0, 1], baseFret: 3 }],
    "Bbm": [{ frets: [1, 1, 0, 1] }],

    // ── Sharp/Flat Dominant 7 alternatives (Cavaquinho) ───────
    "C#7": [{ frets: [1, 1, 1, 0] }],
    "Db7": [{ frets: [1, 1, 1, 0] }],
    "Eb7": [{ frets: [3, 3, 3, 1], barres: [{ fret: 3, from: 0, to: 2 }], baseFret: 3 }],
    "F#7": [{ frets: [2, 2, 2, 0], barres: [{ fret: 2, from: 0, to: 2 }] }],
    "Ab7": [{ frets: [1, 3, 1, 1], baseFret: 3 }],
    "G#7": [{ frets: [1, 3, 1, 1], baseFret: 3 }],
    "Bb7": [{ frets: [1, 1, 0, 2] }],

    // ── Sharp/Flat Minor 7 alternatives (Cavaquinho) ──────────
    "C#m7":[{ frets: [1, 1, 0, 0] }],
    "Ebm7":[{ frets: [3, 3, 2, 1], baseFret: 3 }],
    "F#m7":[{ frets: [2, 2, 1, 0] }],
    "Abm7":[{ frets: [1, 1, 0, 0], baseFret: 3 }],
    "Bbm7":[{ frets: [1, 1, 0, 0], baseFret: 1 }],

    // ── Sharp/Flat Maj7 alternatives (Cavaquinho) ─────────────
    "C#maj7":[{ frets: [1, 1, 1, 0] }],
    "C#M7":  [{ frets: [1, 1, 1, 0] }],
    "Ebmaj7":[{ frets: [3, 3, 3, 2], baseFret: 3 }],
    "EbM7":  [{ frets: [3, 3, 3, 2], baseFret: 3 }],
    "F#maj7":[{ frets: [2, 2, 2, 1] }],
    "F#M7":  [{ frets: [2, 2, 2, 1] }],
    "Abmaj7":[{ frets: [3, 3, 3, 2], baseFret: 3 }],
    "AbM7":  [{ frets: [3, 3, 3, 2], baseFret: 3 }],
    "Bbmaj7":[{ frets: [1, 1, 1, 0] }],
    "BbM7":  [{ frets: [1, 1, 1, 0] }],
  },
  ukulele: {
    // ── Major alternatives ─────────────────────────────────────
...
/**
 * Detect whether the current page is in light mode.
 */
 ...
 * with HIGH CONTRAST theme-aware colors, thicker lines, and
 * larger bold finger numbers for maximum mobile legibility.
 * X/O indicators at bottom, thick nut, rectangular barre.
 */
export function drawChordDiagram(
  ...
  // ── Layout constants ──
  const nutH = isFirstPosition ? Math.max(5, Math.round(h * 0.035)) : 0;
  ...
  const gridLineColor   = light ? "hsl(220, 15%, 30%)" : "hsl(220, 10%, 58%)";
  const stringLineColor = light ? "hsl(220, 15%, 28%)" : "hsl(220, 10%, 55%)";
  const nutColor        = light ? "hsl(220, 15%, 20%)" : "hsl(220, 10%, 82%)";
  const dotColor        = light ? "hsl(220, 20%, 15%)" : "hsl(220, 15%, 92%)";
  const dotTextColor    = light ? "hsl(0, 0%, 100%)"   : "hsl(220, 20%, 8%)";
  const barreColor      = light ? "hsl(220, 20%, 15%)" : "hsl(220, 15%, 92%)";
  const indicatorColor  = light ? "hsl(220, 15%, 20%)" : "hsl(220, 15%, 88%)";
  const mutedColor      = light ? "hsl(0, 70%, 45%)"   : "hsl(0, 65%, 60%)";
  const baseFretColor   = light ? "hsl(220, 15%, 25%)" : "hsl(220, 10%, 65%)";
  const unavailableColor = light ? "hsl(220, 10%, 50%)" : "hsl(220, 10%, 45%)";
  ...
  // ── Base fret indicator (e.g. "2ª") — LARGER and BOLD ──
  if (!isFirstPosition && voicing?.baseFret) {
    ctx.fillStyle = baseFretColor;
    ctx.font = `700 ${Math.round(fretSpacing * 0.38)}px system-ui, -apple-system, sans-serif`;
    ctx.textAlign = "right";
    ctx.textBaseline = "middle";
    ctx.fillText(`${voicing.baseFret}ª`, effectiveSidePadLeft - 4, gridTop + fretSpacing * 0.5);
  }

  // ── Grid: horizontal fret lines — THICKER ──
  for (let f = 0; f <= numFrets; f++) {
    const y = gridTop + f * fretSpacing;
    ctx.strokeStyle = gridLineColor;
    ctx.lineWidth = f === 0 && !isFirstPosition ? 2 : 1.4;
    ctx.beginPath();
  ...
  if (!voicing) {
    ...
    ctx.font = `500 ${Math.round(w * 0.07)}px system-ui, sans-serif`;
  ...
  // ── Barres (thick rectangular bar) — MORE VISIBLE ──
  if (voicing.barres) {
  ...
  // ── Fret dots with LARGER BOLD finger numbers ──
  for (let s = 0; s < voicing.frets.length; s++) {
    ...
    if (fret > 0) {
      ...
      // LARGER BOLD finger number (50%+ bigger than before)
      if (fingers[s] > 0) {
        ctx.fillStyle = dotTextColor;
        ctx.font = `800 ${Math.round(dotRadius * 1.5)}px system-ui, -apple-system, sans-serif`;
        ctx.textAlign = "center";
        ctx.textBaseline = "middle";
  ...
  // ── Bottom indicators: X (muted) and O (open) — THICKER ──
  if (voicing) {
    const indY = gridTop + gridH + bottomIndicatorH * 0.55;
    const indR = Math.max(4, dotRadius * 0.55);
    for (let s = 0; s < voicing.frets.length; s++) {
      const fret = voicing.frets[s];
      const x = effectiveSidePadLeft + s * stringSpacing;
      if (fret === -1) {
        // X mark — thicker strokes
