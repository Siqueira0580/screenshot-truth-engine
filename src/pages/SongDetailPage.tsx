...
export default function SongDetailPage() {
  ...
  return (
    <div className="w-full max-w-4xl min-w-0 space-y-4 overflow-x-hidden sm:space-y-6 landscape:space-y-2 animate-fade-in">
      ...
      {aiChordPro && (
        <div
          className={cn("w-full max-w-full min-w-0 overflow-x-hidden rounded-lg border border-border bg-card px-2.5 py-4 sm:p-6 space-y-3", typographyClasses)}
      ...
      {!aiChordPro && displayBody && (
        <div
          className={cn("w-full max-w-full min-w-0 overflow-x-hidden rounded-lg border border-border bg-card px-2.5 py-4 sm:p-6", typographyClasses)}
          style={{ fontFamily: currentFontFamily }}
        >
          <ChordText
            text={displayBody}
